...
if rerun_eulerian:
	...
	print('')
	print("Second-order Adams Basforth for 'truth'")
	st = time.time()
	t = 0.0
	c = c0.copy()
	while t < max_time-1e-10:
		...
		t += dt
		print('   t = {:0.5f}'.format(t), max_time, '\r', end='')
		uo = u
		vo = v
		co = c
		cxo = cx
...
# Gerr =   2.4e-4  1.3e-4  1.1e-4  1.0e-4   
# Rerr =   1.8e-4  4.3e-5  1.1e-5  2.8e-6   
# N = 400
# dt =             0.005   0.0025  0.00125
# Gerr =           5.2e-5  2.1e-5  1.4e-5   
# Rerr =           4.4e-5  1.1e-5  2.7e-6   
# N = 800
# dt =                     0.0025  0.00125
# Gerr =                   1.2e-5     
# Rerr =                   1.1e-5     

# spectral diff cheating
# N = 200
# dt =     0.01    0.005   0.0025  0.00125
# Gerr =   7.5e-3  1.3e-4  1.1e-4  1.0e-4   
# Rerr =   6.0e-3  4.3e-5  1.1e-5  2.8e-6   
# N = 400
# dt =             0.005   0.0025  0.00125
# Gerr =           5.2e-5  2.1e-5  1.4e-5   
# Rerr =           4.4e-5  1.1e-5  2.7e-6   
